  ...
  return (
    <section className="w-full py-20 ">
      <h1 className="font-bold text-4xl md:text-5xl text-center">
        My <span className="text-[#25aae1]">Approach</span>
      </h1>
...
const Card = ({
  ...
  return (
    ...
    >
      ...
      <Icon className="absolute h-6 w-6 -bottom-3 -left-3text-white " />
      ...
      <div className="relative z-20">
        ...
        <h2 className="text-white text-3xl opacity-0 group-hover/canvas-card:opacity-100 relative z-10  mt-4  font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition text-center duration-200">
          {title}
        </h2>
        <h2
          className="text-white text-sm opacity-0 group-hover/canvas-card:opacity-100 relative z-10  mt-4  font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition text-center duration-200"
          style={{ color: "#e4ecff" }}
        >
          {description}
        </h2>
